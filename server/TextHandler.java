...
public class TextHandler { 
    ...
    public void process(int a) {
        ...
        p.sendQuest("@red@Block List", 5717);
        p.sendQuest("@whi@Add Name", 5070);
        p.sendQuest("@red@Del Name", 5071);
        p.sendQuest("@whi@Add Name", 5720);
        p.sendQuest("@red@Del Name", 5721);
        ...
        p.sendFrame126("@yel@Shops", 175);
        p.sendFrame126("@red@PkBox", 177);
        p.sendFrame126("@gre@GSMINI", 185);
        p.sendFrame126("@gre@Barrow", 186);
        p.sendFrame126("@red@TeamPK", 173);
        p.sendFrame126("@gre@Guilds", 179);
        p.sendFrame126("@gre@Slayer", 187);
        p.sendFrame126("@gre@Skills", 176);
